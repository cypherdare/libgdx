...
public class TextureArrayAtlas extends TextureAtlas {
	...
	public AtlasRegion addRegion (String name, TextureRegion textureRegion) {
		AtlasRegion region = super.addRegion(name, textureRegion);
		if (textureRegion instanceof TextureArrayRegion)
			region.setLayer(((TextureArrayRegion)textureRegion).layer);
		return region;
	}
	...
	protected AtlasRegion addRegion (String name, Texture texture, int x, int y, int width, int height, int layer) {
